...
• 15 indicators across economy, defense, and education</br>
• Generates a line chart saved as chart.png</br>
• Prints a data summary — average, peak year, lowest year</br>

• Input validation at every step</br>
• Live data from the World Bank API — always up to date</br>
...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=F7F7F7&width=435&lines=Made+by+Ivan+Goel" alt="Typing SVG" /></a>
